...
6. `𐱈` (BAŞ) tamgalar.json ligatur grubunda (Tekin 2003 s. 23); fal 17 çift 𐰆 kalır (kitap doğrulaması bekliyor). Kurgu (yazıt tanığı olmayan) örnek kelime kullanılmaz; her örnek Tekin 2003 sözlüğü veya yazıt yeriyle atıflı olur.
